 ...
 * @constructor
 */
 function MyLamp(scene, slices, stacks, radius, minS, maxS, minT, maxT) {
...
MyLamp.prototype.initBuffers = function() {
	...
	var k = 0;
	var beta = (90 * deg2rad) / this.stacks;
	...
	for (var j = 0; j < this.stacks-1; j++) {
		for (var i = 0; i < this.slices; i++) {
			//console.log((alfa * i)/deg2rad + " " + (beta + beta * j)/deg2rad;
           ...
           // if (i == this.slices - 1) {
                ...
                this.indices.push(k + 1);
                this.indices.push(j * this.slices * 2 + 1);
                this.indices.push(j * this.slices * 2);
                */
           // } else {
           	this.indices.push(k + 0);
